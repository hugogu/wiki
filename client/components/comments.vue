      ...
      v-timeline-item.comments-post(
        ...
        v-card.elevation-1
          v-card-text
            ...
            .comments-post-date.overline.grey--text {{ $formatMoment(cm.createdAt, 'from') }} #[em(v-if='cm.createdAt !== cm.updatedAt') - {{$t('common:comments.modified', { reldate: $formatMoment(cm.updatedAt, 'from') })}}]
